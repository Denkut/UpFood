			...
			<div className="max-w-md rounded-lg bg-white p-8">
				...
				<div className="mb-4 text-gray-700">
					<p>
						...
						указывают на то, что этот рацион содержит ингредиенты,
					...
					<p>
						...
						указывают на то, что этот рацион соответствует вашей
						цели питания.
					</p>
					<hr />
					<p>
						...
						означает, что он соответствует вашей цели, но также
						содержит ингредиенты, на которые у вас есть аллергия.
					</p>
				</div>
				<button
