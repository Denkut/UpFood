...
export const MealContent = ({
	meal: { id, title, imageUrl, type, calories, dietCategories, price },
}) => {
	...
	const [editedData, setEditedData] = useState({
		...
		type,
		calories,
		dietCategories: Array.isArray(dietCategories)
			? dietCategories.join(', ')
			: '',
	...
	const handleSave = () => {
		dispatch(updateMealAsync(id, editedData));
				...
				<div className="flex">
					{isEditing ? (
						...
						<>
							...
							/>
							<TrashIcon
								onClick={() => dispatch(deleteMealAsync(id))}
